...
SET @SQLCmd = N'
CREATE TABLE Events.trackingDatabaseActions (
    ...
    CONSTRAINT PK_trackingDatabaseActions PRIMARY KEY CLUSTERED (EventTime, TransactionId, SequenceNumber)
)' + @LedgerTableSuffix + N'

CREATE NONCLUSTERED INDEX IX_trackingDatabaseActions_DatabaseName_EventType
ON Events.trackingDatabaseActions (DatabaseName, EventType)
INCLUDE (EventTime, ServerPrincipalName)
'
